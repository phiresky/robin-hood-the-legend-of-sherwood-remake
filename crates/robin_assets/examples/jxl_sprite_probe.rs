...
//!   to override). Packed RGB565 frames, keyed RGBA export
...
mod probe {
    ...
    fn probe_character(
        ...
        let (_sig, profiles) = SpriteScriptor::load_all_profiles_legacy(&path)
    ...
    fn gather_rle_set(
        ...
        for f in files {
            let Ok((_sig, profiles)) = SpriteScriptor::load_all_profiles_legacy(
