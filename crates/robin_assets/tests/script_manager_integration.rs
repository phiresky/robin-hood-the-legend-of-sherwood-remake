...
///
/// The original game initializes the VM from the mission bytecode and requires
/// that mission bytecode to bind a `StartUp` class.
#[test]
...
///
/// The original game constructs a VM instance by looking up its serialized
/// class and follows the equivalent class-binding path.
#[test]
