...
impl PersistedEnemyAi {
    pub fn capture(runtime: &EnemyAi) -> Self {
        ...
        Self {
            ...
            previous_state: previous_state.raw(),
            previous_substate: previous_substate.raw(),
    ...
    pub fn into_runtime(self) -> EnemyAi {
        EnemyAi {
            ...
            previous_state: StoredEnumWord::from_raw(self.previous_state),
            previous_substate: StoredEnumWord::from_raw(self.previous_substate),
