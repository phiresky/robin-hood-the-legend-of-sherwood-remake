...
impl PersistedAiController {
    pub fn capture(runtime: &AiController) -> Self {
        ...
        Self {
            ...
            alert_path_id: alert_path_id.clone(),
            current_state: current_state.clone(),
            current_substate: current_substate.clone(),
            old_state: old_state.clone(),
            current_music_alert_status: current_music_alert_status.clone(),
            view_alert_status: view_alert_status.clone(),
            substate_at_last_timer_launch: substate_at_last_timer_launch.clone(),
            attitude: attitude.clone(),
            blood_alcohol: blood_alcohol.clone(),
            initial_action: initial_action.clone(),
            number_of_looks: number_of_looks.clone(),
            has_patrol_path: has_patrol_path.clone(),
            patrol_path: patrol_path.clone(),
            detached_patrol_path_status: detached_patrol_path_status.clone(),
            can_move: can_move.clone(),
            stop_before_end_of_path: stop_before_end_of_path.clone(),
            use_max_norm_to_stop_before_end_of_path: use_max_norm_to_stop_before_end_of_path
                .clone(),
            stop_before_end_of_path_distance: stop_before_end_of_path_distance.clone(),
            think_recursion_depth: think_recursion_depth.clone(),
            macro_command: macro_command.clone(),
            macro_command_offset: macro_command_offset.clone(),
            macro_command_waypoint: macro_command_waypoint.clone(),
            number_of_remaining_macro_bytes: number_of_remaining_macro_bytes.clone(),
            macro_in_progress: macro_in_progress.clone(),
            macro_started_in_this_frame: macro_started_in_this_frame.clone(),
            primary_target: primary_target.clone(),
            friend_in_trouble: friend_in_trouble.clone(),
            detected_body: detected_body.clone(),
            interesting_object: interesting_object.clone(),
            antagonist: antagonist.clone(),
            last_stimulus_actor: last_stimulus_actor.clone(),
            timer_is_running: timer_is_running.clone(),
            when_does_timer_ring: when_does_timer_ring.clone(),
            macro_timer_is_running: macro_timer_is_running.clone(),
            when_does_macro_timer_ring: when_does_macro_timer_ring.clone(),
            standing_around_timer: standing_around_timer.clone(),
            sorrow_level: sorrow_level.clone(),
            last_stimulus: last_stimulus.clone(),
            last_stimulus_multiplicity: last_stimulus_multiplicity.clone(),
            is_master: is_master.clone(),
            master: master.clone(),
            seek_position: seek_position.clone(),
            alert_soldiers_point: alert_soldiers_point.clone(),
            first_try: first_try.clone(),
            panic_center_x: panic_center_x.clone(),
            panic_center_y: panic_center_y.clone(),
            lasting_panic_runs: lasting_panic_runs.clone(),
            directed_panic: directed_panic.clone(),
            list_us: list_us.clone(),
            list_alerted_us: list_alerted_us.clone(),
            list_staying_us: list_staying_us.clone(),
            couldnt_reachpoint: couldnt_reachpoint.clone(),
            already_on_point: already_on_point.clone(),
            already_turned: already_turned.clone(),
            completion_latch_inside_think: completion_latch_inside_think.clone(),
            likes_to_sit_around: likes_to_sit_around.clone(),
            special_action: special_action.clone(),
            remaining_tequila_gulps: remaining_tequila_gulps.clone(),
            friends_are_alerted: friends_are_alerted.clone(),
            is_stay_at_home: is_stay_at_home.clone(),
            locks_flag_field: locks_flag_field.clone(),
            was_busy: was_busy.clone(),
            stimulus_queue: stimulus_queue
                .iter()
                .map(|value| PersistedStimulus::capture(value))
                .collect(),
            script_locked: script_locked.clone(),
            remember_events: remember_events.clone(),
            leave_house_number: leave_house_number.clone(),
            last_hint_actuality: last_hint_actuality.clone(),
            last_hint_subject: last_hint_subject.clone(),
            my_door_index: my_door_index.clone(),
            looking_for_help_because_enemy_seen: looking_for_help_because_enemy_seen.clone(),
            forgotten_objects: forgotten_objects.clone(),
            object_of_desire: object_of_desire.clone(),
            checkpoint_charly: checkpoint_charly.clone(),
            synchronize_charly: synchronize_charly.clone(),
            synchronize_index: synchronize_index.clone(),
            delta_sorrow_level: delta_sorrow_level.clone(),
            missed_in_action: missed_in_action.clone(),
            frame_when_enemy_detected: frame_when_enemy_detected.clone(),
            inside_halt_method: inside_halt_method.clone(),
            synchronizing_actors: synchronizing_actors.clone(),
            default_path_walking_flags: default_path_walking_flags.clone(),
            forbidden_remark_ids: forbidden_remark_ids.clone(),
            initial_view_cone: initial_view_cone.clone(),
            current_remark: current_remark.clone(),
            current_remark_flags: current_remark_flags.clone(),
            next_macro_rand: next_macro_rand.clone(),
            next_macro_rand_forecasted: next_macro_rand_forecasted.clone(),
            current_emoticon_type: current_emoticon_type.clone(),
            emoticon_expiration_date: emoticon_expiration_date.clone(),
            emoticon_has_expiration_date: emoticon_has_expiration_date.clone(),
            my_reconnaissance_report: my_reconnaissance_report.clone(),
            knocked_out_in_money_fight: knocked_out_in_money_fight.clone(),
            looted_after_money_fight: looted_after_money_fight.clone(),
            patrol_chief: patrol_chief.clone(),
            patrol: patrol.clone(),
            missed_patrol_members: missed_patrol_members.clone(),
            theoretical_patrol: theoretical_patrol.clone(),
            patrol_stopped: patrol_stopped.clone(),
            patrol_direction: patrol_direction.clone(),
            needs_patrol_reinit: needs_patrol_reinit.clone(),
            got_the_beggar_trick: got_the_beggar_trick.clone(),
            ai_log: ai_log.clone(),
            debug_view_cone_enabled: debug_view_cone_enabled.clone(),
            last_goto_destination: last_goto_destination.clone(),
            last_goto_flags: last_goto_flags.clone(),
            stuck_counter: stuck_counter.clone(),
            outbox: PersistedAiOutbox::capture(outbox),
            has_script_filter_override: has_script_filter_override.clone(),
            last_synced_focus_target: last_synced_focus_target.clone(),
            initial_position: initial_position.clone(),
            initial_view_direction: initial_view_direction.clone(),
            max_visibility: max_visibility.clone(),
            cached_frame: cached_frame.clone(),
            cached_in_building: cached_in_building.clone(),
        }
    }
...
impl PersistedAiGlobalState {
    pub fn capture(runtime: &AiGlobalState) -> Self {
        let AiGlobalState {
            ...
            red_alert_soldiers,
            there_are_royalist_soldiers,
            there_are_lacklandist_soldiers,
            soldier_camps,
        ...
        Self {
            green_alert_soldiers: green_alert_soldiers.clone(),
            yellow_alert_soldiers: yellow_alert_soldiers.clone(),
            red_alert_soldiers: red_alert_soldiers.clone(),
            there_are_royalist_soldiers: there_are_royalist_soldiers.clone(),
            there_are_lacklandist_soldiers: there_are_lacklandist_soldiers.clone(),
            soldier_camps: soldier_camps.clone(),
            stupid_soldiers_cheat: stupid_soldiers_cheat.clone(),
            freeze: freeze.clone(),
            overall_alert_status: overall_alert_status.clone(),
            overall_villain_alert_status: overall_villain_alert_status.clone(),
            ambush_points: ambush_points.clone(),
            seek_points: seek_points.clone(),
            archery_sectors: archery_sectors.clone(),
            saved_random_seed: saved_random_seed.clone(),
            ...
            attribute_display: attribute_display.clone(),
            speech_display: speech_display.clone(),
            golden_eye_mode: golden_eye_mode.clone(),
            ezekiel_2517: ezekiel_2517.clone(),
            current_speech_variant: current_speech_variant.clone(),
            repulsive_points: repulsive_points.clone(),
            next_repulsive_point_id: next_repulsive_point_id.clone(),
    ...
    pub fn into_runtime(self) -> AiGlobalState {
        AiGlobalState {
            ...
            there_are_royalist_soldiers: self.there_are_royalist_soldiers,
            there_are_lacklandist_soldiers: self.there_are_lacklandist_soldiers,
...
impl PersistedQueuedSelfStimulus {
    pub fn capture(runtime: &QueuedSelfStimulus) -> Self {
        ...
        Self {
            stimulus_type: stimulus_type.clone(),
        }
    }
...
impl PersistedStimulus {
    pub fn capture(runtime: &Stimulus) -> Self {
        ...
        Self {
            ...
            info: info.clone(),
            owner: owner.clone(),
            to_whole_patrol: to_whole_patrol.clone(),
        }
    }
    ...
    pub fn capture(runtime: &AiDetectionOutbox) -> Self {
        ...
        Self {
            stimuli: stimuli
                ...
                .map(|value| PersistedStimulus::capture(value))
                .collect(),
            mark_alerted: mark_alerted.clone(),
        }
    }
    ...
    pub fn capture(runtime: &AiReentrantOutbox) -> Self {
        ...
        Self {
            ...
            self_stimuli: self_stimuli
                .iter()
                .map(|value| PersistedQueuedSelfStimulus::capture(value))
                .collect(),
            finish_macro_after_self_stimuli: finish_macro_after_self_stimuli.clone(),
            owner_work: owner_work.clone(),
            reconsider_approach_completion_pending: reconsider_approach_completion_pending.clone(),
            reconsider_approach_replaced_path_waiter: reconsider_approach_replaced_path_waiter
                .clone(),
            battle_observe_completion_pending: battle_observe_completion_pending.clone(),
            look_for_help_completion_pending: look_for_help_completion_pending.clone(),
            waypoint_script_reach_point: waypoint_script_reach_point.clone(),
            alert_soldier_completion_pending: alert_soldier_completion_pending.clone(),
            dead_body_alert_completion_pending: dead_body_alert_completion_pending.clone(),
            tower_guard_alert_officer_completion_pending:
                tower_guard_alert_officer_completion_pending.clone(),
            civilian_report_alert_officer_completion_pending:
                civilian_report_alert_officer_completion_pending.clone(),
            brawl_hitting_completion_pending: brawl_hitting_completion_pending.clone(),
        }
    }
...
impl PersistedEnemyAi {
    pub fn capture(runtime: &EnemyAi) -> Self {
        ...
        Self {
            ...
            pending_special_strike: pending_special_strike.clone(),
            pending_sword_strike_consideration: pending_sword_strike_consideration.clone(),
            pending_combat_insult_after_strike_consideration:
                pending_combat_insult_after_strike_consideration.clone(),
            missed_pc: missed_pc.clone(),
            pc_missed: pc_missed.clone(),
            pc_gone_away_in_this_direction: pc_gone_away_in_this_direction.clone(),
            frame_when_missed_charly: frame_when_missed_charly.clone(),
            heard_nets: heard_nets.clone(),
            detected_something_there: detected_something_there.clone(),
            investigating_distraction: investigating_distraction.clone(),
            last_seek_direction_index: last_seek_direction_index.clone(),
            beggar_to_examine: beggar_to_examine.clone(),
            beggar_is_npc: beggar_is_npc.clone(),
            current_task_priority: current_task_priority.clone(),
            minimal_task_priority: minimal_task_priority.clone(),
            new_task_priority: new_task_priority.clone(),
            number_of_different_checkpoints: number_of_different_checkpoints.clone(),
            thirsty: thirsty.clone(),
            position_change_locked_for_test: position_change_locked_for_test.clone(),
            ...
            seen_dead_body: seen_dead_body.clone(),
            seeking_charly: seeking_charly.clone(),
            ...
            seek_center: seek_center.clone(),
            actual_seek_point: actual_seek_point.clone(),
            seek_point_view_directions: seek_point_view_directions.clone(),
            seek_flags: seek_flags.clone(),
            old_odds: old_odds.clone(),
            gather_position: gather_position.clone(),
            gather_direction: gather_direction.clone(),
            gather_position_instructed: gather_position_instructed.clone(),
            search_charly_way: search_charly_way.clone(),
            officers_position: officers_position.clone(),
            previous_state: previous_state.clone(),
            previous_substate: previous_substate.clone(),
            reported_to_officer: reported_to_officer.clone(),
            missed_soldier_timer: missed_soldier_timer.clone(),
            old_money: old_money.clone(),
            ...
            archer_behind_me: archer_behind_me.clone(),
            shield_bearer_before_me: shield_bearer_before_me.clone(),
            shield_bearer_direction: shield_bearer_direction.clone(),
            phalanx_aborted: phalanx_aborted.clone(),
            changed_to_alert_path: changed_to_alert_path.clone(),
            ...
            pending_group_instruction_seek_flags: pending_group_instruction_seek_flags.clone(),
            pending_group_instruction_clear_location_after_accept:
                pending_group_instruction_clear_location_after_accept.clone(),
            my_shooting_point: my_shooting_point.clone(),
            my_archery_sector: my_archery_sector.clone(),
            my_archery_sector_index: my_archery_sector_index.clone(),
            my_archery_point_index: my_archery_point_index.clone(),
            my_archery_point_increment: my_archery_point_increment.clone(),
            enemy_seen_below: enemy_seen_below.clone(),
            enemy_had_this_elevation: enemy_had_this_elevation.clone(),
            known_enemy_strike_1: known_enemy_strike_1.clone(),
            known_enemy_strike_2: known_enemy_strike_2.clone(),
            known_enemy_strike_3: known_enemy_strike_3.clone(),
            return_to_patrol_point: return_to_patrol_point.clone(),
            fleeing_seen_enemy_counter: fleeing_seen_enemy_counter.clone(),
            last_stimulus_dispatched_to_patrol: last_stimulus_dispatched_to_patrol
                .as_ref()
                .map(|value| PersistedStimulus::capture(value)),
            character_id: character_id.clone(),
            old_life_points: old_life_points.clone(),
            initial_life_points: initial_life_points.clone(),
            list_them: list_them.clone(),
            ambush_point_array_reset: ambush_point_array_reset.clone(),
            ambush_point_status: ambush_point_status.clone(),
            forced_next_battle_decision: forced_next_battle_decision.clone(),
            reset_battle_decision: reset_battle_decision.clone(),
            soldier_profile_iq: soldier_profile_iq.clone(),
            soldier_profile_courage: soldier_profile_courage.clone(),
            soldier_profile_shooting: soldier_profile_shooting.clone(),
            soldier_profile_vip: soldier_profile_vip.clone(),
            soldier_profile_bee_time: soldier_profile_bee_time.clone(),
            soldier_profile_pride: soldier_profile_pride.clone(),
            soldier_profile_hearing_factor: soldier_profile_hearing_factor.clone(),
            soldier_profile_rank: soldier_profile_rank.clone(),
            soldier_profile_initiative: soldier_profile_initiative.clone(),
            soldier_profile_beer: soldier_profile_beer.clone(),
            ale_reliable_distraction: ale_reliable_distraction.clone(),
            soldier_profile_money: soldier_profile_money.clone(),
            soldier_profile_apple: soldier_profile_apple.clone(),
            soldier_profile_whistle: soldier_profile_whistle.clone(),
            soldier_profile_duty: soldier_profile_duty.clone(),
            soldier_profile_endurance: soldier_profile_endurance.clone(),
            is_vip: is_vip.clone(),
            sword_range: sword_range.clone(),
            hth_weapon_id: hth_weapon_id.clone(),
            sword_is_charge_weapon: sword_is_charge_weapon.clone(),
            next_sword_strike_frame: next_sword_strike_frame.clone(),
            company_number: company_number.clone(),
            left_combat_neighbour: left_combat_neighbour.clone(),
            right_combat_neighbour: right_combat_neighbour.clone(),
            attentive: attentive.clone(),
            will_be_attentive: will_be_attentive.clone(),
            forced_attentive: forced_attentive.clone(),
            guarded_pc: guarded_pc.clone(),
            my_line_jump: my_line_jump.clone(),
            tower_guard: tower_guard.clone(),
            combat_trainer: combat_trainer.clone(),
            is_archer_unit: is_archer_unit.clone(),
        }
    }
...
impl PersistedFriendlyAi {
    pub fn capture(runtime: &FriendlyAi) -> Self {
        ...
        Self {
            base: PersistedAiController::capture(base),
            beggar_dont_talk_counter: beggar_dont_talk_counter.clone(),
            fleeing_seen_enemy_counter: fleeing_seen_enemy_counter.clone(),
            wants_to_talk: wants_to_talk.clone(),
            last_talk_partner: last_talk_partner.clone(),
            can_go_away: can_go_away.clone(),
        }
    }
