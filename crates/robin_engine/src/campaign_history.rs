...
//!
//! Unknown values reconstructed while adopting an original-game save are
...
pub enum MissionAttemptSource {
    ...
    Native = 0,
    /// Reconstructed from fields serialized by the original game.
...
/// honest about evidence that the legacy format discarded.
#[derive(
    Debug,
    Clone,
    Default,
