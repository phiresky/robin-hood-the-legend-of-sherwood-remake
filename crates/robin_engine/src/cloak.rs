...
///
/// The original game treats every spy-posture target alike, while its entity
/// model
/// Original-game behavior indicates that the animal runtime is dead in shipped
...
pub struct CloakObservation {
    ...
    /// The original game has no such profile value, and its animal runtime is dead in
