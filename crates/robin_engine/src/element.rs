...
impl PersistedElementData {
    pub(crate) fn capture(value: &ElementData) -> Self {
        ...
        Self {
            ...
            blipped: value.blipped.clone(),
            class_id: value.class_id.clone(),
            active: value.active.clone(),
            hidden_in_building: value.hidden_in_building.clone(),
            sprite_id: value.sprite_id.clone(),
            select_id: value.select_id.clone(),
            position_map_delayed: value.position_map_delayed.clone(),
            delayed_map_position: value.delayed_map_position.clone(),
            position_delayed: value.position_delayed.clone(),
            delayed_position: value.delayed_position.clone(),
            in_honolulu: value.in_honolulu.clone(),
            index_in_elements_list: value.index_in_elements_list.clone(),
            custom_minimap_dot: value.custom_minimap_dot.clone(),
            outline_colors: value.outline_colors.clone(),
            current_outline: value.current_outline.clone(),
            outline_width: value.outline_width.clone(),
            unreachable: value.unreachable.clone(),
            posture: value.posture.clone(),
            sprite: crate::sprite::SpriteSnapshot::capture(&value.sprite),
            grid_cell: value.grid_cell.clone(),
        }
    }
...
impl PersistedAiActorData {
    pub(crate) fn capture(value: &AiActorData) -> Self {
        ...
        Self {
            register_number: value.register_number.clone(),
            number_of_arrows: value.number_of_arrows.clone(),
            direction_old: value.direction_old.clone(),
            initial_view_direction: value.initial_view_direction.clone(),
            initial_position_x: value.initial_position_x.clone(),
            initial_position_y: value.initial_position_y.clone(),
            initial_position_sector: value.initial_position_sector.clone(),
            initial_position_level: value.initial_position_level.clone(),
            inform_my_friends: value.inform_my_friends.clone(),
            money: value.money.clone(),
            wasp_victim: value.wasp_victim.clone(),
            old_cover_noise_deafness: value.old_cover_noise_deafness.clone(),
            old_cover_noise_deafness_frame_counter: value
                .old_cover_noise_deafness_frame_counter
                .clone(),
            stuck_on_ladder_emergency_counter: value.stuck_on_ladder_emergency_counter.clone(),
            attached_scroll: value.attached_scroll.clone(),
            body_visitors: value.body_visitors.clone(),
            fried_pikachu: value.fried_pikachu.clone(),
            detectable_lists: value.detectable_lists.clone(),
            detection_suspects: value.detection_suspects.clone(),
            maximal_detection_suspect: value.maximal_detection_suspect.clone(),
            worst_detected_type: value.worst_detected_type.clone(),
            has_given_money_to_beggar: value.has_given_money_to_beggar.clone(),
            custom_values: value.custom_values.clone(),
            display_double_status_bar: value.display_double_status_bar.clone(),
            ai_brain: PersistedAiBrain::capture(&value.ai_brain),
            alerted: value.alerted.clone(),
            view_radius: value.view_radius.clone(),
            eye_status: value.eye_status.clone(),
            half_aperture: value.half_aperture.clone(),
            real_half_aperture: value.real_half_aperture.clone(),
            view_angle: value.view_angle.clone(),
            view_angle_step: value.view_angle_step.clone(),
            view_transition: value.view_transition.clone(),
            view_half_angle_range: value.view_half_angle_range.clone(),
            view_angle_iterator: value.view_angle_iterator.clone(),
            view_angle_iterator_step: value.view_angle_iterator_step.clone(),
            view_radius_base: value.view_radius_base.clone(),
            view_radius_goal: value.view_radius_goal.clone(),
            view_radius_step: value.view_radius_step.clone(),
            view_alpha_start: value.view_alpha_start.clone(),
            view_longrange_radius_factor: value.view_longrange_radius_factor.clone(),
            view_half_aperture_cosine: value.view_half_aperture_cosine.clone(),
            view_future_half_aperture: value.view_future_half_aperture.clone(),
            view_half_aperture_step: value.view_half_aperture_step.clone(),
            view_half_aperture_changes: value.view_half_aperture_changes.clone(),
            view_crazy_angle_iterator: value.view_crazy_angle_iterator.clone(),
            view_crazy_angle_iterator_step: value.view_crazy_angle_iterator_step.clone(),
            view_crazy_color_iterator: value.view_crazy_color_iterator.clone(),
            view_crazy_half_angle_range: value.view_crazy_half_angle_range.clone(),
            view_direction: value.view_direction.clone(),
            view_left_side: value.view_left_side.clone(),
            view_right_side: value.view_right_side.clone(),
            view_lean_out: value.view_lean_out.clone(),
            drunken_cone_iterators: value.drunken_cone_iterators.clone(),
            view_radius_reduction_permil: value.view_radius_reduction_permil.clone(),
            view_sniper: value.view_sniper.clone(),
            stare_point: value.stare_point.clone(),
            follow_target: value.follow_target.clone(),
        }
    }
...
impl PersistedNpcData {
    pub(crate) fn capture(value: &NpcData) -> Self {
        ...
        Self {
            life_points: value.life_points.clone(),
...
///
/// The original game's default repulsive point leaves its four force
/// scalars uninitialized. Object elements nevertheless serialize the whole
...
impl PersistedElementScroll {
    pub(crate) fn capture(value: &ElementScroll) -> Self {
        ...
        Self {
            ...
            tutorial: value.tutorial.clone(),
            script_class: value.script_class.clone(),
            script_hourglass_timeout: value.script_hourglass_timeout.clone(),
        }
    }
