...
impl PersistedPlayerRuntime {
    pub(crate) fn capture(value: &PlayerRuntime) -> Self {
        ...
        Self {
            ...
            user_locked: value.user_locked.clone(),
            view_locked: value.view_locked.clone(),
            selection_before_user_lock: value.selection_before_user_lock.clone(),
            qa_recording_for: value.qa_recording_for.clone(),
            qa_recording_slot: value.qa_recording_slot.clone(),
            action_before_recording_macro: value.action_before_recording_macro.clone(),
