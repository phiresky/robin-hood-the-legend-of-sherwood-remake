...
impl PersistedCameraState {
    pub(crate) fn capture(value: &CameraState) -> Self {
        ...
        Self {
            view_position: value.view_position.clone(),
            camera_slide: value.camera_slide.clone(),
            camera_wanted: value.camera_wanted.clone(),
            fixed_camera_speed: value.fixed_camera_speed.clone(),
            zoom_factor: value.zoom_factor.clone(),
            desired_zoom_factor: value.desired_zoom_factor.clone(),
            zoom_init_done: value.zoom_init_done.clone(),
            mechanized_zoom: value.mechanized_zoom.clone(),
            level_size: value.level_size.clone(),
            displacement: value.displacement.clone(),
            displacement_counter: value.displacement_counter.clone(),
            position_saved: value.position_saved.clone(),
            sequence_element: value.sequence_element.clone(),
            external_completion_replay: value.external_completion_replay.clone(),
            display: value.display.clone(),
            pending_zoom_mouse_screen: value.pending_zoom_mouse_screen.clone(),
        }
    }
...
///
/// Wired at level-load time into [`LevelRuntimeAttachments::pixel_opacity`]: the host
...
impl PersistedMissionScript {
    pub(crate) fn capture(value: &MissionScript) -> Result<Self, String> {
        ...
        Ok(Self {
            ...
            spellforge_virtual_bindings_enabled: value.spellforge_virtual_bindings_enabled.clone(),
            post_initialized: value.post_initialized.clone(),
        })
    }
...
impl PersistedSideEffects {
    pub(crate) fn capture(value: &SideEffects) -> Self {
        ...
        Self {
            ...
            invalidate_background: value.invalidate_background.clone(),
            invalidate_trajectory_preview: value.invalidate_trajectory_preview.clone(),
            reset_input: value.reset_input.clone(),
            fade_to_black: value.fade_to_black.clone(),
            set_draw_hidden: value.set_draw_hidden.clone(),
            skip_render: value.skip_render.clone(),
            ...
            pending_sherwood_report: value.pending_sherwood_report.clone(),
            trade_receipts: value.trade_receipts.clone(),
            pending_show_console: value.pending_show_console.clone(),
            pending_mark_pc_ids: value.pending_mark_pc_ids.clone(),
            bg_blits: value.bg_blits.clone(),
            pending_silent_win_widget_swap: value.pending_silent_win_widget_swap.clone(),
            pending_mission_state_notice: value.pending_mission_state_notice.clone(),
            cancel_multi_selection: value.cancel_multi_selection.clone(),
            pending_reset_input: value.pending_reset_input.clone(),
            pending_swordfight_drag_ignore: value.pending_swordfight_drag_ignore.clone(),
            ui_has_focus: value.ui_has_focus.clone(),
