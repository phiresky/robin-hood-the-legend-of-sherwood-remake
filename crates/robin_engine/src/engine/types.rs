...
struct CompatibleGameHost {
    ...
    _fast_grid: Option<crate::fast_find_grid::FastFindGrid>,
...
impl MissionScript {
    ...
    /// not-yet-migrated entity and AI owners. Campaign, mission statistics,
    /// and the fast grid remain in `EngineInner` and are borrowed explicitly
    /// by `NativeContext`.
