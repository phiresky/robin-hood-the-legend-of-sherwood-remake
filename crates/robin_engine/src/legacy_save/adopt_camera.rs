...
//!
//! Original-game engine saves write the camera and raw
//! background transform near the start of the engine body. On read it then
...
impl LegacyCameraAdoptionPlan {
    pub(crate) fn preflight(
        ...
        // Original read-side normalization validates the camera location at
        // serialized view plus half the screen size divided by zoom,
...
fn convert_background(
    ...
    BackgroundTransform {
        ...
        // Original-game engine restoration forcibly clears these immediately after
...
mod tests {
    ...
    fn reproduces_original_read_side_camera_normalization() {
        ...
        // Camera-location validation truncates the reconstructed top-left.
