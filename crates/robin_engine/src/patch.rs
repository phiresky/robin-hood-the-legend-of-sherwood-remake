...
impl PersistedPatch {
    pub(crate) fn capture(value: &Patch) -> Self {
        ...
        Self {
            ...
            door_triggered: value.door_triggered.clone(),
            triggers_door: value.triggers_door.clone(),
            integrate_in_background: value.integrate_in_background.clone(),
            animation_flags: value.animation_flags.clone(),
            use_changing_obstacles: value.use_changing_obstacles.clone(),
            pathfinder_layer: value.pathfinder_layer.clone(),
            pathfinder_sector: value.pathfinder_sector.clone(),
            pathfinder_changing_obstacles: value.pathfinder_changing_obstacles.clone(),
            layer: value.layer.clone(),
            sector: value.sector.clone(),
            waypoint: value.waypoint.clone(),
            ...
            apply_sector_index: value.apply_sector_index.clone(),
        }
    }
