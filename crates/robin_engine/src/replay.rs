...
/// On-disk replay schema version. Version 8 requires the complete campaign and
...
/// snapshots first-owner active-ability and actor Execute initialization.
pub const REPLAY_SCHEMA_VERSION: u32 = 8;
