...
pub struct SectorProduction {
    ...
    /// script-sector reference and asserts both single attachment and attachment
...
pub struct ProductionForecast {
    ...
    /// Script-authored production speed (the unscaled production-sector registration
...
impl SectorProduction {
    ...
    /// Original-game production arithmetic, including its
    ...
    /// Compute the per-point bonus drops for the current mission,
    /// capped at 5/point. Returns `(point_index, quantity)`
