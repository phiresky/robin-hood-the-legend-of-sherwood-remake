...
/// The original game keeps the material-sector reference returned by water/hole detection and
/// uses that same polygon to calculate the falling trajectory.
...
/// material-sector reference returned for the actual impact obstacle.
...
/// Resolve water/hole material from material sub-sectors of the exact impact obstacle
