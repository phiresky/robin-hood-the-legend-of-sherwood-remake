...
impl Database {
    ...
    async fn full_campaign_leaderboard_rows(
        &self,
        filter: &robin_run_protocol::RunFilterV1,
        cursor: Option<&BoardCursor>,
        limit: u32,
    ...
    async fn public_participants_for_run(
        &self,
        run_id: &str,
    ...
    async fn public_participants_for_runs(
        &self,
        run_ids: &[String],
    ...
    async fn public_participants_for_full_campaign(
        &self,
        run_id: &str,
    ...
    async fn public_participants_for_full_campaigns(
        &self,
        run_ids: &[String],
    ...
    async fn full_campaign_sessions_for_runs(
        &self,
        run_ids: &[String],
    ...
    /// submission: the one-use challenge was consumed before streaming.
    ...
    async fn existing_submission_by_challenge(
        &self,
