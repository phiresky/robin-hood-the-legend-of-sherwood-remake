//! Bounded legacy save decoding, independent of simulation adoption.
...
/// Concrete original-game save layout identified by the serialized header.
///
