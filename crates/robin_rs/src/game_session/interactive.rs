...
pub(super) struct MissionUi {
    ...
    pub(super) pending_terminal_debriefing:
        Option<super::terminal_debriefing::PendingTerminalDebriefing>,
...
impl MissionUi {
    pub(super) fn new(restart_allowed: bool) -> Self {
        Self {
            ...
            pending_terminal_debriefing: None,
...
impl InteractiveRendererAssembly {
    ...
    pub(super) fn assemble_process_frontend(
        ...
        Ok(InteractiveFrontendAssembly {
...
pub(super) struct ProcessInterfaceResources {
    ...
    pub(super) audio_backend: Option<crate::audio_backend::KiraAudioBackend>,
...
impl MissionPresentation {
    ...
    pub(super) fn render_context<'a>(
        ...
        RenderContext {
            ...
            cursor_renderer: &self.sprites.cursor_renderer,
            ...
            hud_tooltips: super::render::HudTooltipPresentation::prepare(
                ...
                &hud.blazon_tooltip,
                &hud.stature_tooltip,
                &hud.sherwood_tooltip,
                &hud.pc_action_tooltip,
            ),
...
pub(super) struct InteractiveMission {
    ...
    /// Exit payload belongs to this mission and moves into its consuming outcome.
    pub(super) campaign_transition: Option<crate::main_entry::PendingLevelLoad>,
}
