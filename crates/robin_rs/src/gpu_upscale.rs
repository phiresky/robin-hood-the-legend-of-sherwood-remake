...
mod tests {
    ...
    #[ignore = "requires GPU; see docs/TESTING.md"]
        ...
        pollster::block_on(async {
                ...
                .await
            {
                    ...
                    .await
                {
                    ...
                    Err(hardware_error) => {
                        panic!(
                            "required headless multipass smoke test has no adapter; fallback={fallback_error}; hardware={hardware_error}"
                        );
                    }
                },
            };
            ...
            crate::renderer::verify_offscreen_gpu_contract(gpu.clone());
