...
mod tests {
    ...
    fn persisted_projection_preserves_historical_wire_and_reconstructs_scratch() {
        ...
        let historical = HistoricalSoundManager {
            ...
            sound_enabled: manager.persisted.sound_enabled.clone(),
            music_directory: manager.persisted.music_directory.clone(),
            sound_system_ready: manager.persisted.sound_system_ready.clone(),
            active: manager.persisted.active.clone(),
            sound_mode: manager.persisted.sound_mode.clone(),
            use_3d_sound: manager.persisted.use_3d_sound.clone(),
            can_3d_sound: manager.runtime.can_3d_sound.clone(),
            can_eax_sound: manager.runtime.can_eax_sound.clone(),
            forest_level: manager.persisted.forest_level.clone(),
            num_channels: manager.persisted.num_channels.clone(),
            ...
            music_mode: manager.persisted.music_mode.clone(),
            loop_index: manager.persisted.loop_index.clone(),
            quiet_mode_weight: manager.persisted.quiet_mode_weight.clone(),
            alert_mode_weight: manager.persisted.alert_mode_weight.clone(),
            fight_mode_weight: manager.persisted.fight_mode_weight.clone(),
            has_mission_music: manager.runtime.has_mission_music.clone(),
            has_menu_music: manager.runtime.has_menu_music.clone(),
            load_music: manager.persisted.load_music.clone(),
            start_music: manager.persisted.start_music.clone(),
            update_music: manager.runtime.update_music.clone(),
            update_pending_sounds: manager.runtime.update_pending_sounds.clone(),
            jingle_channel: manager.runtime.jingle_channel.clone(),
            stop_jingle: manager.runtime.stop_jingle.clone(),
            dialog_mode: manager.persisted.dialog_mode.clone(),
            dialog_finished: manager.runtime.dialog_finished.clone(),
            has_dialog: manager.runtime.has_dialog.clone(),
            stop_dialog: manager.runtime.stop_dialog.clone(),
            pending_jingle: manager.runtime.pending_jingle.clone(),
        };
        ...
        let historical_runtime = SoundRuntime {
            can_3d_sound: old_decoded.can_3d_sound.clone(),
            can_eax_sound: old_decoded.can_eax_sound.clone(),
            ...
            has_mission_music: old_decoded.has_mission_music.clone(),
            has_menu_music: old_decoded.has_menu_music.clone(),
            update_music: old_decoded.update_music.clone(),
            update_pending_sounds: old_decoded.update_pending_sounds.clone(),
            jingle_channel: old_decoded.jingle_channel.clone(),
            stop_jingle: old_decoded.stop_jingle.clone(),
            dialog_finished: old_decoded.dialog_finished.clone(),
            has_dialog: old_decoded.has_dialog.clone(),
            stop_dialog: old_decoded.stop_dialog.clone(),
            pending_jingle: old_decoded.pending_jingle.clone(),
        };
        assert_eq!(
            empty_runtime,
