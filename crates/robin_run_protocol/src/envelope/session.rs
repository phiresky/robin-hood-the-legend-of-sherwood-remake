...
use super::{
    ...
    NAMED_SEAT_JOIN_SIGNATURE_DOMAIN_V1, PreparedMissionInputsSealV1,
    REPLAY_SESSION_GENESIS_SIGNATURE_DOMAIN_V1, SignatureAlgorithmV1,
};
...
// Speech timing and the anonymous seat transcript are consumed by the
// deterministic engine, so they live in the `robin_run_types` leaf.
pub use robin_run_types::session::{
    ReplaySeatLifecycleEventV1, ReplaySeatLifecycleKindV1, ReplaySessionTranscriptV1,
