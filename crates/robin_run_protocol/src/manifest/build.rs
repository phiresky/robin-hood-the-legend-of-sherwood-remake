...
pub const WASM_BINDGEN_CLI_VERSION_V1: &str = "0.2.128";
...
pub const WASM_BINDGEN_CLI_AUTHORITY_SHA256_V1: Digest32 = Digest32::from_bytes([
    0xa9, 0x1c, 0xc0, 0x3b, 0x96, 0xfd, 0xaf, 0xdc, 0x92, 0x3a, 0x88, 0x00, 0x09, 0xcf, 0x4a, 0xe0,
    0x8c, 0x51, 0x57, 0x57, 0x8e, 0x03, 0x21, 0x79, 0x08, 0x22, 0x8e, 0x7c, 0xc3, 0xb9, 0x8a, 0x03,
]);
    ...
    fn validate(&self) -> Result<(), ValidationError> {
        ...
        let (version, url, sha256, byte_length, executable_relative_path) = match self.role {
            BuildToolRoleV1::WasmBindgenCli => (
                ...
                "https://static.crates.io/crates/wasm-bindgen-cli/wasm-bindgen-cli-0.2.128.crate",
                Digest32::from_bytes([
                    0x2e, 0x29, 0x14, 0x0c, 0x04, 0xe8, 0x18, 0x32, 0x90, 0x2b, 0x70, 0xe5, 0xd3,
                    0x7b, 0x9c, 0xe1, 0xbf, 0xa8, 0x11, 0xc8, 0xfe, 0x45, 0x63, 0xbe, 0xa0, 0x8f,
                    0x76, 0xdf, 0x83, 0x88, 0xcf, 0x20,
                ]),
                53_205,
                "bin/wasm-bindgen",
            ),
