...
//! This module maps it to a typed `Instruction`. The opcode determines
//! each operand's type, byte order, and position in the serialized layout.
//!
...
fn decode_with(op: Opcode, ops: [u8; 8]) -> Instruction {
    ...
    match op {
        ...
        // int(i32)@4. Parameter assignment uses the u16-at-0 slot as the
        // source symbol and the i32-at-4 slot as the destination offset.
