...
target/debug/cpf_to_json /absolute/path/Data/Configuration/profile.cpf target/profile.cpf.json
```
...
target/debug/cpf_to_json target/patched-profile.cpf.json target/validated-profile.cpf.json
```
