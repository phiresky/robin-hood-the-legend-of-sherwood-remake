...
| In progress | Frame-47 soldier turn frontier | Soldier 113 is in command `Turn` / AI substate 10 in Original but `Wait` / substate 15 in Rust. | Audit the turn launch and AI substate transition from the matching frame-46 engine dump. |
