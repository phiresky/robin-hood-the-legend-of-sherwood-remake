...
established Enemy→Body→Object→Friend→MissedFriend→Beggar FIFO. Swapped
...
civilian VIEW regressions protect the completed boundary. Missing observer
