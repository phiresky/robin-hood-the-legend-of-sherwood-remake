...
- #64 completed: Soldier PrepareToEnterSwordFight now promotes its exact reciprocal Enter at the synchronous Think boundary before unrelated postponed work can take over. This restores the frame-1600 ReconsiderSwordfight/ProposeGoodSwordStrike RNG calls; the same-frame post-state residual is #67.
