...
- #38 partially completed: Smalltalk back-hit now uses Original's isometric facing vector, restoring ReceiveSwordDamage and its two protection draws in the Nescafe control. The heterogeneous UpdateSwordfightDistance, EvaluateSwordfight, FindPositionForTableSwordfight, and other protection subfamilies remain open; the "rng:VipIdleRemark" label is only a classifier artifact.
