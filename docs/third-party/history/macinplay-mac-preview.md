...
Wernicke compares a Mac demo with the full PC game while discussing the upcoming e.p.i.c. release. The preview praises the accessible controls, sound, narrative, and tactical depth, and describes German voice acting and three difficulty levels.

Its distinctive evidence is performance: the author reports stuttering on a 700 MHz G3 even at 640×480 and questions the port's higher hardware demands. The article describes detailed 2D environments and a maximum resolution of 1024×768.

These are observations from a prerelease demo and that machine. They should not be treated as measurements of later Mac builds. The preview's advertised mission total likewise needs comparison with campaign route conventions.
...
##  0 Gedanken zu „Robin Hood: Die Legende von Sherwood (Vorschau)“ 

  1. Pingback: [macinplay » Blog-Archiv » [Mac] Robin Hood feiert sein Comeback](http://www.macinplay.de/wordpress/2011/09/mac-robin-hood-feiert-sein-comeback/)

  2. Pingback: [macinplay » Blog-Archiv » [Mac] Runesoft bringt weiteren Titel in den Mac App Store - Jack Keane](http://www.macinplay.de/wordpress/2011/10/mac-runesoft-bringt-weiteren-titel-in-den-mac-app-store-jack-keane/)




### Schreibe einen Kommentar [Antwort abbrechen](/spiele-tests/macintosh-games/robin-hood-die-legende-von-sherwood-vorschau/#respond)
...
For security, use of Google's reCAPTCHA service is required which is subject to the Google [Privacy Policy](https://policies.google.com/privacy) and [Terms of Use](https://policies.google.com/terms).
...
* = Affiliate- oder Partnerlink. Ja, wir müssen ein bisschen Geld verdienen.
...
### history__macinplay-mac-preview.txt

_Source: `originals/history__macinplay-mac-preview.txt`._
