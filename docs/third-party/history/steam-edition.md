# Steam — localized store description
...
The store identifies Spellbound as developer, Microids as publisher, and app ID 46560. It describes single-player play, over thirty missions, nine characters, varied mission types, mouse-driven combat, and changing atmospheric conditions.

The interface language table lists English, French, German, and Spanish. The [Portuguese storefront](https://store.steampowered.com/app/46560/Robin_Hood_The_Legend_of_Sherwood/?l=portuguese) translates marketing text while explicitly marking Portuguese game support unavailable. Store-page language therefore is not evidence of a game localization.

Publisher-selected review endorsements point to ActionTrip, GameSpy, and GameZone. They are discovery leads, not substitutes for reading those original reviews.

**Limitations:** the listing's 1 November 2002 date differs from other release databases. Historical system requirements and GPU exclusions may describe an older package. No purchase or installation was performed.
...
[ Añadir al carro ](javascript:addToCart\(11342\);)

Ver centro de la comunidad
...
[Ver todos](https://store.steampowered.com/curators/curatorsreviewing/?appid=46560&snr=1_5_9__top-curators)

## Lo que dicen los mentores

27 mentores han reseñado este producto. Haz clic [aquí](https://store.steampowered.com/curators/curatorsreviewing/?appid=46560&snr=1_5_9__top-curators) para verlos. 

Filtros de reseñas

Puedes usar este creador de widgets para generar un fragmento de código HTML que puede insertarse en tu sitio web para permitir que los usuarios compren este producto en Steam fácilmente.

Introduce un máximo de 375 caracteres para añadir una descripción a tu widget:

Crear widget

Copia y pega el HTML de aquí debajo en tu sitio web para hacer que se muestre el widget de arriba

## Etiquetas populares para este producto:(?)

## Iniciar sesión

Regístrate para añadir tus propias etiquetas a este producto.

[ Iniciar sesión ](https://store.steampowered.com/login/?redir=app/46560)


### history__steam-edition.txt

_Source: `originals/history__steam-edition.txt`._
