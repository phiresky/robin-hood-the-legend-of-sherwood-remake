...
- Language / date: English; no revision date shown on the installer page
- Access: Full installer page retrieved directly (YAML and JSON views)
- Checked: 2026-09-09
...
### technical__lutris-desura-script.txt

_Source: `originals/technical__lutris-desura-script.txt`._
