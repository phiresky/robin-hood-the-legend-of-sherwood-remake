...
- Original source: [Lutris installer — Robin Hood: The Legend of Sherwood (Desura)](https://lutris.net/games/install/7091/view)
- Author / publication: Lutris installer contributors; no individual author or revision date shown
- Language: English
- Access: Full installer page retrieved directly; the page exposes YAML (script only), full YAML, and JSON views
- Checked: 2026-09-09
- Format: Original page text converted to Markdown; site navigation, account controls, and footer removed
