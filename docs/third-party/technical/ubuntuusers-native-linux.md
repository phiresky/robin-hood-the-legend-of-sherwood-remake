# ubuntuusers — archived native Linux instructions

- Original source: [ubuntuusers — archived native Linux instructions](https://wiki.ubuntuusers.de/Archiv/Spiele/Robin_Hood_-_Die_Legende_von_Sherwood/)
- Author / publication: ubuntuusers wiki contributors
- Language / date: German; displayed revision 2022-10-29
- Access: Full page text and raw wiki markup retrieved directly
- Checked: 2026-09-09
...
Documents installation of the native Linux CD edition using an updated Mojo installer, including the filename `robin.hood_1.2-multilingual.cdrom_x86-20121119.mojo.run`.

It says the manual is supplied as a PDF in the installation directory, provides demo leads, and lists Alt+Enter or F12 for fullscreen switching and Alt+G for mouse capture. These shortcuts describe that port and should not automatically be assigned to the original Windows game.

**Status:** the page explicitly states that it is archived, unmaintained, and untested on currently supported Ubuntu versions.

**Research use:** historical Linux packaging, installer naming, manual location, and port-specific controls. The linked installer and demo were not fetched or run.
...
Der aktuallisierten Installer von [bitbucket.org](https://bitbucket.org/runesoftdev/robinhood_public/wiki/Home) 🇬🇧 ⮷ herunterladen und ausführbar [1] machen.

Die Installation des Spiels wird nach dem einbinden der CD über das Installationsskript gestartet [2]: 
...
Ein Demo zu diesem Spiel kann man von [softpedia.com](http://linux.softpedia.com/progDownload/Robin-Hood-The-Legend-of-Sherwood-Download-9620.html) 🇬🇧 oder [](https://www.holarse-linuxgaming.de/wiki/)[holarse-linuxgaming.de](http://files.holarse-linuxgaming.de/native/Spiele/Robin%20Hood%3A%20Die%20Legende%20von%20Sherwood/Demo/) ⮷ herunterladen. Dies wird nach dem obigen Muster installiert.
...
[](https://media-cdn.ubuntu-de.org/wiki/attachments/12/28/games.png)
...
[Diese Revision](https://wiki.ubuntuusers.de/Archiv/Spiele/Robin_Hood_-_Die_Legende_von_Sherwood/a/revision/1006227/) wurde am 29. Oktober 2022 10:37 von [DJKUhpisse](https://ubuntuusers.de/user/DJKUhpisse/) erstellt.   
...
[[Bild(robin.png,100,align=left)]]
Bei dem Spiel schlüpft man in die Rolle des Helden Robin Hood - dem Helden aus einer mittelalterlichen englischen Legende - und erweckt ihn so zum Leben. Robin Hood war ein Geächteter, der die Reichen bestahl und das Diebesgut den armen Menschen gab. Mit seinen Gesellen bekämpft Robin in diversen Missionen Prinz John, den Sheriff von Nottingham und andere Charaktere im Sherwood Forest und der Umgebung von Nottingham. Taktik und Charaktere mit unterschiedlichen Eigenschaften verleihen dem Spiel eine ungeahnte Tiefe. 

{{{#!vorlage Tabelle
<tablestyle="float:right; clear:right" :>[[Bild(./Spielszene2.jpg, x220)]]
<:>[[Bild(./Spielszene.jpg, x220)]]
+++
<:>Spielszene
<:>Spielszene
}}}
= Installation =
== CD-Version ==
Der aktuallisierten Installer von [bitbucket:runesoftdev/robinhood_public/wiki/Home:bitbucket.org] {en} {dl} herunterladen und ausführbar [1] machen. 
...
Nachdem die Spieledaten auf das System kopiert wurden findet man den Starter unter ''"Anwendungen -> Spiele"''. 
...
= Handbuch =
Ein Handbuch zum Spiel ist im Installationsverzeichnis, als [:PDF:], zu finden.

= Demo =
Ein Demo zu diesem Spiel kann man von [http://linux.softpedia.com/progDownload/Robin-Hood-The-Legend-of-Sherwood-Download-9620.html softpedia.com] {en} oder [holarse::][http://files.holarse-linuxgaming.de/native/Spiele/Robin%20Hood%3A%20Die%20Legende%20von%20Sherwood/Demo/ holarse-linuxgaming.de] {dl} herunterladen. Dies wird nach dem obigen Muster installiert. 
...
Funktion
+++
[[Vorlage(Tasten, alt+return)]] / [[Vorlage(Tasten, F12)]] 
Vollbild- / Fenstermodus
+++
[[Vorlage(Tasten, alt+g)]]
Mauszeiger festhalten/freigeben.
}}}

[[Bild(Wiki/Icons/games.png, 48, right)]] 
= Infobox =
{{{#!vorlage Tabelle
<-2 tablestyle="width: 97%;" rowclass="verlauf"> Robin Hood – Die Legende von Sherwood
+++
Originaltitel:
...
Prozessor mind. 500 MHz - mind. 128 MB RAM - mind. 1 GB Festplattenspeicher - Graphikkarte (8+ MB RAM)
+++
Medien:
CD (1)
+++
...
= Links =
 * [http://www.rune-soft.com Runesoft] {de} {en} 
   * [moddb:games/robin-hood-the-legend-of-sherwood:Robin Hood: The Legend of Sherwood]
   * [https://bitbucket.org/runesoftdev/helpdesk/wiki/Home Bitbucket] {en}

# tag: Spiele, unfreie Software, USK12, Linux-Spiel, Strategie, RuneSoft
```
...
Inyoka 1.52.11 
  * 🄯 2004 – 2026 ubuntuusers.de • Einige Rechte vorbehalten  
[Lizenz](https://ubuntuusers.de/lizenz/) • [Kontakt](https://ubuntuusers.de/kontakt/) • [Datenschutz](https://ubuntuusers.de/datenschutz/) • [Impressum](https://ubuntuusers.de/impressum/) • [Serverstatus](https://ubuntuusers.statuspage.io)
  * Serverhosting gespendet von  
[](https://www.anexia.at/managed-hosting/) [](https://www.centron.de/)
