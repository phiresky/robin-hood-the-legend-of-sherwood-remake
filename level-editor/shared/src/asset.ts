...
export interface AssetDescriptor {
  ...
  /** 3D reconstruction (SAM 3D Objects) of this asset, see scene.ts */
  model?: AssetModel;
  /** reconstructions by other backends (key = backend name), for comparison */
  alt_models?: Record<string, AssetModel>;
  /**
   * for block assets: ids of the single-building assets whose masks were
   * merged into this one; scene assembly prefers the block over its members
   */
  merged_from?: string[];
