...
# rmlint was executed from: /home/phire/data/dev/2026/robin-hood-the-legend-of-sherwood/reference-saves/
# Your command line was: rmlint -T df -k -m -g Savegame_linux2 // Savegame_Nescafe
...
Rmlint was executed in the following way:
   ...
   $ rmlint -T df -k -m -g Savegame_linux2 // Savegame_Nescafe
...
then                                           
  ...
  rm -f '/home/phire/data/dev/2026/robin-hood-the-legend-of-sherwood/reference-saves/rmlint.sh';                                     
fi                                             
