...
# the original-game capture helper does. Corpora that were
...
#   ROBIN_BINARY=./original-game/build/native-full/robin
...
binary="${ROBIN_BINARY:-$PWD/original-game/build/native-full/robin}"
