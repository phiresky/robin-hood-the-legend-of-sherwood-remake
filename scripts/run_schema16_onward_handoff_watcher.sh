...
# Historical wrapper; select an explicitly frozen manifest for a new campaign.
...
verify_deployment() {
    ...
    verify_hash "$workspace/original-game/scripts/capture_parity_save_replays.sh" "$expected_capture_sha"
