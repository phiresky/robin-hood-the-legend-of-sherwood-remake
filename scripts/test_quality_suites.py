...
class QualitySuitesTests(unittest.TestCase):
    ...
    def test_replay_format_boundary_rejects_client_packages(self):
    ...
    def test_signer_workspace_dependency_boundary_including_target_and_build_edges(self):
        ...
        def visit(package):
            if package in visited:
                return
            visited.add(package)
            self.assertIn(package, {"robin_identity_signer", "robin_run_protocol", "robin_run_types", "robin_display_text"})
        ...
        self.assertEqual(visited, {"robin_identity_signer", "robin_run_protocol", "robin_run_types", "robin_display_text"})
