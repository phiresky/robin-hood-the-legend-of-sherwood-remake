//! Math library using one pure-Rust libm implementation on every target.
//!
...
pub fn math_random(state: &mut LuaState) -> LuaResult<u32> {
    ...
    match n {
        ...
        1 => {
            ...
            #[allow(clippy::cast_precision_loss)]
            let result = libm::floor(r * u as f64) + 1.0;
        ...
        2 => {
            ...
            #[allow(clippy::cast_precision_loss)]
            let result = libm::floor(r * (u - l + 1) as f64) + l as f64;
            push_num(state, result)
        }
