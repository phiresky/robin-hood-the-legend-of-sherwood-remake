...
pub(crate) struct NativeSurface {
    extra_swapchain_flags: core::sync::atomic::AtomicU32,
    raw: vk::SurfaceKHR,
...
impl NativeSurface {
    pub fn from_vk_surface_khr(
        ...
        Self {
            extra_swapchain_flags: core::sync::atomic::AtomicU32::new(0),
            raw,
            functor,
    ...
    pub fn set_swapchain_create_flags(&self, flags: vk::SwapchainCreateFlagsKHR) {
        self.extra_swapchain_flags.store(flags.as_raw(), core::sync::atomic::Ordering::Relaxed);
    }
...
impl Surface for NativeSurface {
    ...
    unsafe fn create_swapchain(
        ...
        let mut raw_flags = vk::SwapchainCreateFlagsKHR::from_raw(
            self.extra_swapchain_flags.load(core::sync::atomic::Ordering::Relaxed),
        );
...
impl NativeSwapchain {
    ...
    pub unsafe fn set_next_present_chain(&mut self, chain: *mut core::ffi::c_void) {
        self.next_present_chain = (!chain.is_null()).then_some(PresentChain(chain.cast()));
    }
