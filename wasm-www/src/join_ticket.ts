...
const JOIN_CODE_PREFIX = runtimeContract.joinCodePrefix;
const JOIN_TICKET_SCHEMA = runtimeContract.ticketSchema;
const NET_PROTOCOL_VERSION = runtimeContract.netProtocol;
